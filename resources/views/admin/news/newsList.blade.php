  	...
  	<div class="content-wrapper">
  		<div class="col-md-12">
		    <section class="content-header row">
			    <h3>News Lists <i class="fa fa-angle-double-right"></i><a href="{{route('getNewsForm')}}"> Add News</a></h3><br>
		    </section>
		    	...
		    	<tbody>	
	    			...
	    			<tr>
	    				...
	    				<td style="width:8%; vertical-align: middle;text-align: center;">
	    					<?php echo $post->photo != '' ? '<img class="img-responsive" src="/photos/share/thumbs/'.$post->photo.'">' : '<i style="font-size:28px;" class="'.$post->icon.'"></i>';?>
	    				</td>	    					
	    				...
	    				<td>
	    					<a data-url="{{route('DeleteNews')}}"  data-id="{{$post->id}}"  class="btnDeleteNews btn btn-danger btn-xs">Delete</a>
	    					<a href="{{url('admin/news/edit')}}/{{$post->id}}" class="btn btn-info btn-xs">Edit</a>
	    				</td>
	    			</tr>
		    		@endforeach
		    	</tbody>
