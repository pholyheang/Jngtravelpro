  	...
  	<div class="content-wrapper">
  		<div class="col-md-12">
		    <section class="content-header row">
			    <h3>Our Services <i class="fa fa-angle-double-right"></i><a href="{{route('getPost')}}"> Add New</a></h3><br>
		    </section>
		    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
		    	...
		    	<tbody>	
	    			...
	    			<tr>
	    				...
	    				<?php echo $post->image != '' ? '<img class="img-responsive" src="/photo/photo/thumbnail/'.$post->image.'">' : '<i style="font-size:28px;" class="'.$post->icon.'"></i>';?>
	    				</td>
