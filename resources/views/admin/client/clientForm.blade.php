  ...
  <!-- Content Wrapper. Contains page content -->
	<div class="content-wrapper">
	    <section class="content row">	    	
	    	...
	    	<form method="POST" action="{{route('clientCreate')}}" enctype="multipart/form-data">
	    		{{ csrf_field() }}
						    ...
						    <div class="box-body">
						      	<div class="col-md-12 col-md-12">		                   
			                    	<div class="form-group">
			                            <input type="text" id="title" name="title" class="form-control input-md" placeholder="Client Name" required>
			                        </div>		                            
			                      	<div class="form-group">
