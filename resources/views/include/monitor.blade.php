  ...
  <div id="jssor_1" style="position:relative;top:0px;left:0px;width:355px;height:200px;overflow:hidden;visibility:hidden;">
      ...
      <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:355px;height:200px;overflow:hidden;">
            @foreach(\App\SlideShow::where('slide_for', 2)->get() as $key => $slrow )
            <div>
                <img src="/photos/share/{{$slrow->slide}}" alt="{{$slrow->title}}" style="width: 100%; height: 100%;">
                <div data-u="caption" data-t="0" style="position:absolute;top:320px;left:30px;width:355px;height:30px;z-index:0;background-color:rgba(255,188,5,0.8);font-size:20px;color:#ffffff;line-height:30px;text-align:center;">{{$slrow->title}}</div>
            </div>
            @endforeach        
        </div>
        <!-- Bullet Navigator -->
